    ...
    <>
      <div className="flex px-10 bg-purple-100">
        <div className="px-10 py-5 mt-20 mb-10">
          ...
          <p className="flex px-10 mt-5">Being able to predict when your next period will arrive can save you a lot of hassle and help you to understand your own menstrual cycle. Predict your next period now with Flo’s easy-to-use period calculator.</p>
        </div>

        <div className="px-10 mt-20 mb-10">
          <Image src="/period-cal.jpg" alt="period-cal" width={850} height={850} className='rounded-xl'/>
        </div>
      </div>
