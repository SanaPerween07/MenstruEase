    ...
    <div className="flex justify-between items-center bg-indigo-50 px-20 py-10">
      ...
      <div className="ml-5 mt-[-90px] flex flex-col items-end">
        <div className="mb-5 overflow-hidden shadow-lg">
          <Image src="/signUp-stain2.jpg" alt="stain2" className="mb-2 rounded-xl" width={280} height={280}/>
        </div>
        <div className="mr-[-30] overflow-hidden shadow-lg">
          <Image src="/women.jpg" alt="stain1" className="mb-2 rounded-xl" width={135} height={135}/>
        </div>
      </div>

      <div className="mr-10 ml-30 flex flex-col items-end">
        <div className="mb-10 overflow-hidden shadow-lg">
          <Image src="/signUp-stain1.avif" alt="stain1" className="mb-2 rounded-xl" width={220} height={220}/>
        </div>
        <div className="mr-[-30] overflow-hidden shadow-lg ">
          <Image src="/signUp-stain.jpg" alt="stain" className="mb-2 rounded-xl" width={200} height={200}/>
        </div>
      </div>
